...
let fru=["apple","banana","cherry","mango"];
...
// slice
// console.log(fru.slice(0,2));
// Splice - takes 3 parameters, - (from,delete numberof ele/Replace,Elements), - returns none
// fru.splice(2,2,"item1","item2")
// console.log(fru);
...
// let arr2 = new Array('name 1', 'name 2','name 3');
// console.log(arr2);
